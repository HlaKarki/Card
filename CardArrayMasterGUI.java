...
//**********************************************************************************
   ...
   private void stage2()
   {
      ...
      //System.out.println(masterList1);
      if(DEBUGMODE)
   ...
   private void stage9()
   {
      ...
      x+="Card {{98,98}} Should be at (4)->";
      x+=masterList1.indexOf(new Card(98,98));
      x+="  ,  Card (9,9) Should be at (8)->";
      x+=masterList1.indexOf(new Card(9,9)); 
      x+="  ,  Card (7,8) Should be at (-1)->";
      x+=masterList1.indexOf(new Card(7,8));
      x+= " ";
      textData[8].setText(x);
         
      if(DEBUGMODE)
         if (masterList1.indexOf(new Card(98,98)) == 4 &&
           masterList1.indexOf(new Card(7,8)) == -1 &&
